...
class __TwigTemplate_abcc16958bce52ec762b91c3b4940bff66eef1cef69eaf13618e306d36776dcf extends \Twig\Template
{
    ...
    {
        return new Source("", "{# inline_template_start #}<a href=\"#\" class=\"cke-icon-only cke_{{ direction }}\" role=\"button\" title=\"{{ name }}\" aria-label=\"{{ name }}\"><span class=\"cke_button_icon cke_button__{{ classname }}_icon\">{{ name }}</span></a>", "");
    }
}
