...
class __TwigTemplate_0568aaa05a7a22892b435d5a1be2455873e16bb43448198ee9554563fc488e66 extends \Twig\Template
{
...
($context["author_id"] ?? null) && (($context["author_id"] ?? null) == $this->getAttribute(($context["commented_entity"] ?? null), "getOwnerId", [], "method")))) ? ((("by-" . $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["commented_entity"] ?? null), "getEntityTypeId", [], "method"))) . "-author")) : ("")), 5 => "clearfix"];
        ...
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, twig_without($this->sandbox->ensureToStringAllowed($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null)], "method")), "role"), "html", null, true);
        echo ">
  ";
        // line 83
...
";
    ...
    {
        return new Source("", "core/themes/bartik/templates/comment.html.twig", "/var/www/vhosts/nightsession.de/httpdocs/core/themes/bartik/templates/comment.html.twig");
    }
}
